                ...
                <div className="flex-1 overflow-y-auto p-3 space-y-2">
                    ...
                    {rooms.map(room => (
                        <div
                            ...
                            className={`p-3 rounded-xl cursor-pointer transition-colors duration-200 relative ${selectedRoom?.otherUserId === room.otherUserId
                        ...
                        >
                            ...
                            {room.lastMessage && (
                                <p className={`text-sm mt-1 truncate ${selectedRoom?.otherUserId === room.otherUserId ? 'text-blue-100' : (room.unreadCount ? 'text-gray-800 font-semibold' : 'text-gray-500')
                                    }`}>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-4">
                            {messages.map((msg, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`px-4 py-2.5 rounded-2xl max-w-[75%] break-words shadow-sm ${isMe
                        ...
                        <div className="p-4 bg-white border-t border-gray-200">
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    onClick={handleSend}
                                    disabled={!input.trim()}
                                    className={`p-3 rounded-full flex items-center justify-center transition-all ${input.trim()
